...
Curated list of academic and industry papers, **technical blog posts**, and **GitHub PoCs** on car keyless entry security: **RKE** (Remote Keyless Entry), **PKES** (Passive Keyless Entry and Start), attacks (KeeLoq, Hitag2, relay, RollJam, RollBack), and defenses (distance bounding, PUF, MFA, etc.). Papers are stored by year and indexed in CSV for search and filtering. The full index (including blogs and PoCs) is in **papers.csv**.
